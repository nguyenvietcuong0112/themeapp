...
object CdnPathResolver {
     ...
     * Cấu trúc: [CDN_DOMAIN]/themes/[theme_folder]/bg_preview.png
     */
    fun getThemePreviewUrl(themeFolder: String): String {
        return "${cdnDomain.removeSuffix("/")}/themes/${themeFolder.removePrefix("/")}/bg_preview.png"
    }

    /**
     * Lấy URL ảnh gốc chất lượng cao của bộ Theme.
     * Cấu trúc: [CDN_DOMAIN]/themes/[theme_folder]/bg_preview_original.png
    ...
    fun getThemeOriginalUrl(themeFolder: String, deviceType: String? = null): String {
        ...
        return "${cdnDomain.removeSuffix("/")}/themes/${themeFolder.removePrefix("/")}/bg_preview_original$suffix.png"
    }

    /**
     * Lấy URL ảnh nền xem trước (Wallpaper Preview).
     * Cấu trúc: [CDN_DOMAIN]/themes/previews/wallpapers/[theme_folder]/bg_wallpaper.png
     */
    fun getWallpaperPreviewUrl(themeFolder: String): String {
        return "${cdnDomain.removeSuffix("/")}/themes/previews/wallpapers/${themeFolder.removePrefix("/")}/bg_wallpaper.png"
    }

    /**
     * Lấy URL ảnh nền gốc chất lượng cao (Full-HD).
     * Cấu trúc: [CDN_DOMAIN]/themes/[theme_folder]/wallpapers/[image_name].png
     */
    fun getWallpaperFullUrl(themeFolder: String, imageName: String): String {
        ...
        return "${cdnDomain.removeSuffix("/")}/themes/${themeFolder.removePrefix("/")}/wallpapers/$cleanImageName"
    }

    /**
     * Lấy URL ảnh xem trước của bộ Icon (Icon Pack Preview).
     * Cấu trúc: [CDN_DOMAIN]/themes/previews/icons/[theme_folder]/bg_icon.png
     */
    fun getIconPackPreviewUrl(themeFolder: String): String {
        return "${cdnDomain.removeSuffix("/")}/themes/previews/icons/${themeFolder.removePrefix("/")}/bg_icon.png"
    }

    /**
     * Lấy URL ảnh lẻ của từng app (Facebook, Tiktok, Chrome...) trong bộ Icon.
     * Cấu trúc: [CDN_DOMAIN]/themes/[theme_folder]/icons/ic_[icon_id].png
     */
    fun getSingleIconUrl(themeFolder: String, iconId: String): String {
        val cleanIconId = iconId.removePrefix("ic_").removeSuffix(".png")
        return "${cdnDomain.removeSuffix("/")}/themes/${themeFolder.removePrefix("/")}/icons/ic_$cleanIconId.png"
    }

    /**
     * Lấy URL file cấu hình JSON của Widget Template.
     * Cấu trúc: [CDN_DOMAIN]/templates/designs/[template_folder]/config.json
     */
    fun getWidgetConfigUrl(templateFolder: String): String {
        return "${cdnDomain.removeSuffix("/")}/templates/designs/${templateFolder.removePrefix("/")}/config.json"
    }

    /**
     * Lấy URL ảnh xem trước của Widget.
     * Cấu trúc: [CDN_DOMAIN]/themes/{theme_folder}/widgets/bg_{widget_size}.png
     */
    fun getWidgetPreviewUrl(themeFolder: String, widgetSize: String = "medium"): String {
        ...
        return "${cdnDomain.removeSuffix("/")}/themes/$cleanFolder/widgets/bg_$cleanSize.png"
    }
