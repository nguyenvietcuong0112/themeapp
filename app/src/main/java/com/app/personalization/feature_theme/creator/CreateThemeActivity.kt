...
import com.app.personalization.feature_icon.data.entity.ThemeIconPack
import com.app.personalization.feature_wallpaper.data.entity.ThemeWallpaper
import com.app.personalization.feature_widget.data.entity.ThemeWidget
    ...
    private fun saveTheme() {
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            try {
                ...
                val newWidgetTheme = com.app.personalization.feature_widget.data.entity.WidgetTheme(
                    id = themeId,
                    name = "My Custom Theme ${themeId.toString().take(4)}",
                ...
                com.app.personalization.feature_theme.data.ThemeDatabase.getDatabase(this@CreateThemeActivity).themeDao().insertTheme(newWidgetTheme)
                ...
                com.app.personalization.feature_theme.data.ThemeDatabase.getDatabase(this@CreateThemeActivity).wallpaperDao().insertWallpaper(themeWallpaper)
                ...
                com.app.personalization.feature_theme.data.ThemeDatabase.getDatabase(this@CreateThemeActivity).iconDao().insertIconPack(themeIconPack)
                ...
                com.app.personalization.feature_theme.data.ThemeDatabase.getDatabase(this@CreateThemeActivity).widgetDao().insertWidget(themeWidget)

                withContext(Dispatchers.Main) {
                    Toast.makeText(this@CreateThemeActivity, "Đã lưu chủ đề tùy chỉnh thành công!", Toast.LENGTH_SHORT).show()
                    
                    val intent = android.content.Intent(this@CreateThemeActivity, com.app.personalization.feature_widget.DownloadThemeActivity::class.java).apply {
