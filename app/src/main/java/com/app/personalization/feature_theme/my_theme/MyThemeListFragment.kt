package com.app.personalization.feature_theme.my_theme
...
import com.app.personalization.feature_theme.ThemeAdapter
...
class MyThemeListFragment : Fragment() {
    ...
    private fun deleteTheme(theme: com.app.personalization.feature_keyboard.data.entity.KeyboardTheme) {
        lifecycleScope.launch {
            val context = context ?: return@launch
