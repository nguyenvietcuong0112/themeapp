package com.app.personalization.feature_wallpaper.data
...
import com.app.personalization.feature_wallpaper.data.dao.DiyDao
...
@Database(
    entities = [
        DiyBackground::class,
        DiySticker::class,
        com.app.personalization.feature_wallpaper.data.entity.Design::class
    ],
    version = 2,
    exportSchema = false
)
