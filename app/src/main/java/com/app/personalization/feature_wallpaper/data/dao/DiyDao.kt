...
import com.app.personalization.feature_wallpaper.data.entity.DiyBackground
...
interface DiyDao {
    ...
    fun getAllDesigns(): List<com.app.personalization.feature_wallpaper.data.entity.Design>

    @Query("SELECT * FROM diy_designs WHERE id = :id LIMIT 1")
    fun getDesignById(id: java.util.UUID): com.app.personalization.feature_wallpaper.data.entity.Design?

    @Insert(onConflict = OnConflictStrategy.REPLACE)
    fun insertDesign(design: com.app.personalization.feature_wallpaper.data.entity.Design)

    @Delete
    fun deleteDesign(design: com.app.personalization.feature_wallpaper.data.entity.Design)
}
