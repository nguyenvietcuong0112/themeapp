            ...
            if (templatePages.length() > 0) {
                ...
                if (pagesArr.length() > 0) {
                    ...
                    if (subPage.has("bgImage")) {
                        ...
                        val bgUrl = "${com.app.personalization.core.data.ResourceConfig.ASSET_BASE_URL}/assets_wallpaper/templates/$bgImgPath"
                    ...
                    for (i in 0 until components.length()) {
                        ...
                        when (type) {
                            ...
                            "sticker" -> {
                                ...
                                layer.stickerUrl = "${com.app.personalization.core.data.ResourceConfig.ASSET_BASE_URL}/assets_wallpaper/templates/$cleanUrl"
                            ...
                            "image_template" -> {
                                ...
                                layer.sampleImageUrl = "${com.app.personalization.core.data.ResourceConfig.ASSET_BASE_URL}/assets_wallpaper/templates/$cleanSampleImg"
