...
class DownloadThemeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val widgetTheme = intent.getSerializableExtra("widget_theme") as? com.app.personalization.feature_widget.data.entity.WidgetTheme
    ...
    private fun initToolbar() {
        ...
        toolbarBinding.ivInfo.setOnClickListener {
            val intent = Intent(this, com.app.personalization.feature_setting.InfoActivity::class.java)
            startActivity(intent)
        }
        
        toolbarBinding.llCreateWallpaper.root.setOnClickListener {
            val intent = Intent(this, com.app.personalization.feature_wallpaper.diy.DIYWallpaperActivity::class.java)
            startActivity(intent)
        }

        toolbarBinding.llCreateWidget.root.setOnClickListener {
            val intent = Intent(this, com.app.personalization.feature_widget.WidgetConfigActivity::class.java)
            startActivity(intent)
        }
    }
