...
import com.app.personalization.feature_theme.creator.CreateThemeCategoryAdapter
...
class WidgetConfigFragment : Fragment() {
    ...
    private fun onWidgetClicked(item: WidgetTemplateItem) {
        ...
        val dummyTheme = com.app.personalization.feature_keyboard.data.entity.KeyboardTheme(
            id = uuidString,
            name = item.themeName,
            path = item.themePath,
