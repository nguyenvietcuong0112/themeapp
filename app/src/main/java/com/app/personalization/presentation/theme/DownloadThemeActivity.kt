...
class DownloadThemeActivity : AppCompatActivity() {
    ...
    private fun initToolbar() {
        ...
        toolbarBinding.llCreateWallpaper.root.setOnClickListener {
            val intent = Intent(this, com.app.personalization.presentation.editor.DIYWallpaperActivity::class.java)
    ...
    private fun updateTabUI(position: Int) {
        ...
        for (i in tabs.indices) {
            ...
            if (i == position) {
                ...
                tab.typeface = Typeface.create(tab.typeface, Typeface.BOLD)
            } else {
                tab.setTextColor(Color.parseColor("#999999"))
                tab.setBackgroundResource(0)
                tab.typeface = Typeface.create(tab.typeface, Typeface.NORMAL)
            }
        }
    }
    ...
    private fun observeCoins() {
        viewModel.coins.observe(this) { amount ->
            binding.toolbar.gemView.setCoins(amount)
        }
    }
