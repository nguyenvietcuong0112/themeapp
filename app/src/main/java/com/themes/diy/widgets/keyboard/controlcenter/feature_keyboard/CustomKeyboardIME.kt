...
import com.themes.diy.widgets.keyboard.controlcenter.feature_keyboard.model.CustomKeyStyle
import com.themes.diy.widgets.keyboard.controlcenter.feature_keyboard.model.KeyConfig
import com.themes.diy.widgets.keyboard.controlcenter.feature_keyboard.model.ThemeConfig
import com.themes.diy.widgets.keyboard.controlcenter.feature_keyboard.model.FontConfig
import com.themes.diy.widgets.keyboard.controlcenter.feature_keyboard.model.PopupConfig
import com.themes.diy.widgets.keyboard.controlcenter.feature_keyboard.model.KeyDef
...
class CustomKeyboardIME : InputMethodService() {
    ...
    private val themeReceiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context, intent: Intent) {
            if (intent.action == "com.themes.diy.widgets.keyboard.controlcenter.ACTION_THEME_CHANGED") {
    ...
    override fun onCreate() {
        ...
        val filter = IntentFilter("com.themes.diy.widgets.keyboard.controlcenter.ACTION_THEME_CHANGED")
    ...
    override fun onCreateInputView(): View {
        loadActiveTheme()
        com.themes.diy.widgets.keyboard.controlcenter.core.data.DefaultColors.loadBackgroundKey(this, activeTheme)
        loadKeyboardLayout()
    ...
    private fun loadLanguagePopups() {
        ...
        try {
            val locale = prefs.getString("active_locale", "en") ?: "en"
            val filename = "assets_keyboard/language_key_texts/$locale.txt"
            val assetsList = assets.list("assets_keyboard/language_key_texts") ?: emptyArray()
            val targetFile = if (assetsList.contains("$locale.txt")) filename else "assets_keyboard/language_key_texts/en.txt"
    ...
    fun loadKeyboardLayout() {
        parsedRows.clear()
        val layoutPath = if (isSymbolsMode) "assets_keyboard/layouts/symbols.txt" else "assets_keyboard/layouts/$currentLayoutName"
        try {
