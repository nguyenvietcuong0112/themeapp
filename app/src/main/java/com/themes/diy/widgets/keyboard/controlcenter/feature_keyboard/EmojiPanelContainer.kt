...
class EmojiPanelContainer @JvmOverloads constructor(
    ...
    private fun loadStickers() {
        stickersList.clear()
        try {
            val root = "assets_theme/stickers"
        ...
        if (stickersList.isEmpty()) {
            stickersList.add("assets_theme/stickers/sticker7/029-weather.png")
        }
    }
    ...
    private inner class StickerAdapter(val list: List<String>) : BaseAdapter() {
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
            ...
            Glide.with(context)
                .load(com.themes.diy.widgets.keyboard.controlcenter.core.data.ResourceConfig.getKeyboardStickerUrl(assetPath))
                .into(iv)
