...
import com.themes.diy.widgets.keyboard.controlcenter.databinding.ActivityKeyboardThemeDetailBinding
...
class KeyboardThemeDetailActivity : AppCompatActivity() {
    ...
    private fun applyThemeFlow() {
        ...
        lifecycleScope.launch {
            ...
            if (success) {
                ...
                sendBroadcast(Intent("com.themes.diy.widgets.keyboard.controlcenter.ACTION_THEME_CHANGED"))
    ...
    private fun loadDefaultKeyboardLayout(context: Context): List<List<KeyDef>> {
        ...
        try {
            val reader = java.io.BufferedReader(java.io.InputStreamReader(context.assets.open("assets_keyboard/layouts/qwerty.txt")))
            var line: String?
