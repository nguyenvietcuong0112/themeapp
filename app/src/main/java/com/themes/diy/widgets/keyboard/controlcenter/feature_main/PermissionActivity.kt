...
class PermissionActivity : AppCompatActivity() {
    ...
    private fun setupClickListeners() {
        ...
        btnGrantOverlay.setOnClickListener {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                ...
                com.themes.diy.widgets.keyboard.controlcenter.core.utils.PermissionDetector.startDetectingPermission(
                    activity = this,
    ...
    override fun onDestroy() {
        com.themes.diy.widgets.keyboard.controlcenter.core.utils.PermissionDetector.stopDetecting()
        super.onDestroy()
    }
