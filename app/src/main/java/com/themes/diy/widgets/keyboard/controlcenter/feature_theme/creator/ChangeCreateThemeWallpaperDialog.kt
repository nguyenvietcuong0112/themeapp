...
import com.themes.diy.widgets.keyboard.controlcenter.feature_wallpaper.WallpaperViewModel
import com.themes.diy.widgets.keyboard.controlcenter.feature_widget.data.entity.WidgetThemeWallpaper
import com.themes.diy.widgets.keyboard.controlcenter.databinding.FragmentChangeCreateThemeWallpaperBinding
    ...
    private class WallpaperItemAdapter(
        ...
        class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
            ...
            fun bind(item: WidgetThemeWallpaper, onSelected: (WidgetThemeWallpaper) -> Unit) {
                ...
                val resolvedFolder = ResourceConfig.getThemeFolderByPath(itemView.context, item.folder)
                val url = ResourceConfig.getWallpaperFullUrl(resolvedFolder, item.imageBg)
