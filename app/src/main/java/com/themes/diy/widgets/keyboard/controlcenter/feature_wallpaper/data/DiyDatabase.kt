package com.themes.diy.widgets.keyboard.controlcenter.feature_wallpaper.data
...
import com.themes.diy.widgets.keyboard.controlcenter.feature_wallpaper.data.dao.DiyDao
...
@Database(
    entities = [
        DiyBackground::class,
        DiySticker::class,
        com.themes.diy.widgets.keyboard.controlcenter.feature_wallpaper.data.entity.Design::class
    ],
    version = 2,
    exportSchema = false
)
