...
import com.themes.diy.widgets.keyboard.controlcenter.databinding.ActivityDownloadThemeBinding
...
class DownloadThemeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val widgetTheme = intent.getSerializableExtra("widget_theme") as? com.themes.diy.widgets.keyboard.controlcenter.feature_widget.data.entity.WidgetTheme
    ...
    private fun initToolbar() {
        ...
        toolbarBinding.ivInfo.setOnClickListener {
            val intent = Intent(this, com.themes.diy.widgets.keyboard.controlcenter.feature_setting.InfoActivity::class.java)
            startActivity(intent)
        }
        
        toolbarBinding.llCreateWallpaper.root.setOnClickListener {
            val intent = Intent(this, com.themes.diy.widgets.keyboard.controlcenter.feature_wallpaper.diy.DIYWallpaperActivity::class.java)
            startActivity(intent)
        }

        toolbarBinding.llCreateWidget.root.setOnClickListener {
            val intent = Intent(this, com.themes.diy.widgets.keyboard.controlcenter.feature_widget.WidgetConfigActivity::class.java)
            startActivity(intent)
        }
    }
