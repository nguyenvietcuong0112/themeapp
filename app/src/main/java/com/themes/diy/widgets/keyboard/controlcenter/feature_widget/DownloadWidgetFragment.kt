...
import com.themes.diy.widgets.keyboard.controlcenter.databinding.FragmentDownloadWidgetBinding
...
class DownloadWidgetFragment : Fragment() {
        ...
        lifecycleScope.launch {
            val mappedFolder = withContext(Dispatchers.IO) {
                try {
                    ...
                    val diyWidget = com.themes.diy.widgets.keyboard.controlcenter.feature_theme.data.ThemeDatabase.getDatabase(requireContext()).widgetDao().getWidgetsByTheme(uuid)
    ...
    private inner class DownloadWidgetItemAdapter(
        ...
        inner class ViewHolder(val binding: com.themes.diy.widgets.keyboard.controlcenter.databinding.ItemDownloadWidgetLayoutBinding) : RecyclerView.ViewHolder(binding.root)

        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
            val binding = com.themes.diy.widgets.keyboard.controlcenter.databinding.ItemDownloadWidgetLayoutBinding.inflate(
