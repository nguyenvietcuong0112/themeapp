...
class WidgetConfigActivity : AppCompatActivity() {
    ...
    private fun loadCategoriesAndWidgets() {
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            val jsonCategories = ServiceLocator.getThemeRepository(this@WidgetConfigActivity).getCategories()
    ...
    private fun applyWidgetToId(item: WidgetTemplateItem) {
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            try {
                ...
                val cdnUrl = "${ResourceConfig.ASSET_BASE_URL}/assets_theme/${item.themePath}/widgets/$fileName"
