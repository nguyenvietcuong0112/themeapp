package com.themes.diy.widgets.keyboard.controlcenter.feature_widget.data.entity
...
data class WidgetThemeWallpaper(
    ...
    fun getPreviewUri(): Uri {
        return Uri.parse(ResourceConfig.getKeyboardPopupBgUrl(folder, "$imageBg/popup_background.png"))
    }
    ...
    private fun getLocalTintColor(context: Context): Int {
        ...
        val prefix = "assets_keyboard/themes/$folder/$imageBg"
        return try {
